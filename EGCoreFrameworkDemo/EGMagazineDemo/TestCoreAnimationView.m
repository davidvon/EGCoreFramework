...
@implementation TestCoreAnimationView
...
{
    CAKeyframeAnimation *anim = [EGCoreAnimation movePathBySVG:self.view durcation:5.f bySVGFile:@"BezierCurve1"];
...
-(void) animationGroupShow
{
    ...
    CABasicAnimation *anim = [EGCoreAnimation moveX:0.3f X:[NSNumber numberWithInt:680]];
